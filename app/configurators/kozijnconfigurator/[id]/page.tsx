...
const DEFAULT_MATRIX = {
  ...
  profielToeslag: {
    "vlak-82": 0,
    "creon-82": 0,
    "creon-verdiept-120": 0,
    "creon-verdiept-120-hvl": 0,
  },
...
const getKozijnData = (slug: string) => {
  const data = [
    ...
    },
    {
      ...
      v: 1,
      types: ["dk", "vast"],
      name: "Draai/kiep met bovenlicht vast",
    ...
    },
    {
      ...
      v: 1,
      types: ["dk", "kiep"],
      name: "Draai/kiep met bovenlicht kiep",
    ...
    },
    {
      ...
      v: 1,
      types: ["dk", "vast"],
      name: "Draai/kiep met borstwering",
    ...
    },
    {
      ...
      v: 2,
      types: ["dk", "dk"],
      name: "Draai kiep - Draai kiep gelijk",
      components: [
        <GlassDK key="1" x={0} />,
        <GlassDK key="2" x={100} mirror />,
      ],
    ...
    },
    {
      ...
      v: 2,
      types: ["dk", "dk"],
      name: "Draai/kiep - draai stolp bovenlicht",
    ...
    },
    {
      ...
      v: 2,
      types: ["dk", "vast"],
      name: "Draai/kiep - vast bovenlichten",
    ...
    },
    {
      ...
      v: 2,
      types: ["dk", "kiep"],
      name: "Draai/kiep bovenlicht kiep - vast",
    ...
    },
    {
      ...
      v: 2,
      types: ["vast", "kiep"],
      name: "Vast bovenlicht kiep - vast",
    ...
    },
    {
      ...
      v: 2,
      types: ["dk", "vast"],
      name: "Draai/kiep bovenlicht vast - vast",
    ...
    },
    {
      ...
      v: 3,
      types: ["vast", "dk", "vast"],
      name: "Vast - DK - Vast bovenlichten",
...
export default function ConfiguratorDetail() {
  ...
  useEffect(() => {
    getMatrix("kozijn_matrix").then((data: any) => {
      ...
      m.glasToeslag = Object.fromEntries(
        Object.keys(DEFAULT_MATRIX.glasToeslag).map((k) => [
          k,
      ...
      setVentilatieRooster(
        Object.keys(m.ventilatieRoosterToeslag || {})[0] || "",
      );
  ...
  if (!matrix)
    return <div className="p-10 text-center">Prijzen ophalen...</div>;
  if (!kozijn)
    return (
      <div className="p-10 text-center text-red-500">Kozijn niet gevonden.</div>
    );
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-6 md:py-10">
        <Link
          href="/kozijnen"
          className="text-slate-400 text-[11px] uppercase tracking-wider hover:text-[#1066a3]">
          ← Overzicht
        </Link>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
              ...
              {sel(
                ...
                ventilatieRooster,
                setVentilatieRooster,
                matrix.ventilatieRoosterToeslag || {},
              )}
              {sel(
                "Voorboren",
                voorboren,
                setVoorboren,
                matrix.voorborenToeslag || {},
              )}
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-9 h-9 rounded-lg border text-lg font-bold text-slate-600 hover:bg-slate-50">
                    −
                  </button>
