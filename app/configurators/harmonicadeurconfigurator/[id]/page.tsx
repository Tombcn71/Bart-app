...
const DEFAULT_MATRIX = {
  ...
  kleurBuitenzijdeToeslag: {
    "ral-9016-wit": 0,
    "ral-7016-antraciet": 0,
    "ral-9005-zwart": 0,
    "ral-kleur": 0,
  },
  kleurBinnenzijdeToeslag: {
    "ral-9016-wit": 0,
    "ral-7016-antraciet": 0,
    "ral-9005-zwart": 0,
    "ral-kleur": 0,
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border rounded-xl p-6 space-y-4">
              ...
              {sel(
                ...
                typeLak,
                setTypeLak,
                matrix.typeLakToeslag || {},
              )}
              {sel(
                "Kleur buitenzijde",
                kleurBuiten,
                setKleurBuiten,
                matrix.kleurBuitenzijdeToeslag || {},
              )}
              {sel(
                "Kleur binnenzijde",
                kleurBinnen,
                setKleurBinnen,
                matrix.kleurBinnenzijdeToeslag || {},
              )}
              ...
              {sel(
                ...
                draairichting,
                setDraairichting,
                matrix.draairichtingToeslag || {},
              )}
              {sel(
                "Volgorde",
                volgorde,
                setVolgorde,
                matrix.volgordeToeslag || {},
              )}
              {sel(
                "Voorboren",
                voorboren,
