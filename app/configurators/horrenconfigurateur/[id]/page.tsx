...
const horData: Record<string, { name: string; component: React.ReactNode }> = {
  inzethor: { name: "Inzethor",  component: <InzethorSVG /> },
  klemhor:  { name: "Klemhor",   component: <KlemhorSVG /> },
};
...
export default function HorConfigurator() {
  const { id } = useParams();
  const slug = typeof id === "string" ? id : "inzethor";
  const hor = horData[slug] ?? horData["inzethor"];
  ...
  const basisPrijs = slug === "klemhor" ? 89 : 69;
  const prijs = Math.round(basisPrijs * m2 * aantal * 100) / 100;
    ...
    <div className="max-w-[1200px] mx-auto p-4 md:p-12 lg:p-16 font-sans bg-white min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-6">
        ...
        <div className="lg:col-span-7">
          <h1 className="text-2xl font-semibold mb-6">{hor.name}</h1>
        ...
        <div className="lg:col-span-5">
          <form onSubmit={handleSubmit} className="bg-white border p-6 rounded-xl shadow-sm space-y-5">
            ...
            <div>
              ...
              <input
                type="number" min={300} max={2500} value={breedte}
            ...
            <div>
              ...
              <input
                type="number" min={300} max={3000} value={hoogte}
            ...
            <div>
              ...
              <input
                type="number" min={1} max={50} value={aantal}
